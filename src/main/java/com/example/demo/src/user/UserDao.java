...
//        String modifyUserNameQuery = "update User set paymentType = ? where userIdx = ? "; // 해당 userIdx를 만족하는 User를 해당 nickname으로 변경한다.
//        Object[] modifyUserNameParams = new Object[]{patchUserReq.getPaymentType(), patchUserReq.getUserIdx()}; // 주입될 값들(nickname, userIdx) 순
//
